...
<div class="container">
    ...
    <center><h1 class="Secondary">Welcome to the website class schedule</h1></center>
		...
		<div class="col-md-12" style="margin-top: 10px">
			 ...
			 *ใส่หมู่เรียน
			<br />
			<form action="show_table.php" method="POST" class="form-horizontal">
				<div class="form-group row">
					<div class="col-sm-5">
						<!-- <input type="text" name="major_name" class="form-control"  required> -->
						ชื่อสาขา :  <input type="text" name="major_name"  value="" class="form-control"  required>
					...
					<div class="col-sm-2">
						<button type="submit" name="submit" class="btn btn-primary">ค้นหา
						</button>
					</div>
				</div>
