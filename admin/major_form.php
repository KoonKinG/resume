...
<br>
<form action="major_form_db.php" method="post" name="form1" onSubmit="Javascript:return fncSubmit();">
<div class="container">
<div class="row">
    <div class="col"></div>
    <div class="col">
      <div class="card text-center">
      <h3><div class="card-header text-white bg-dark">เพิ่มสาขา</div></h3>
      <div class="card-body">
        <p class="card-text">
        สาขา : <input type="text" name="major_name" placeholder="Enter Major "><br>
        </p>
        <button type="submit" class="btn text-white bg-dark">Add major</button>
      </div>
