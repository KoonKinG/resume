...
//        echo "</script>";
  ...
  echo "<script>";
   echo "alert('$major_id ตารางนักศึกษาไม่ว่าง !!');";
  
  echo "window.location='Schedule_form22.php';";
  echo "</script>";
...
//        echo "</script>";
  ...
  echo "<script>";
  echo "alert('$tc_id ตารางอาจารย์ไม่ว่าง !!');";
  echo "window.location='Schedule_form22.php';";
  echo "</script>";
...
$room_id= $_POST["room_id"];
  ...
  if($num1==0 && $num2==0 && $num3==0){
    ...
    day_id='$day_id',
    status_s=1 
    WHERE major_id = $major_id AND subject_id = $subject_id";
      ...
      mysqli_close($conn);
        ...
        if($result4){
          echo "<script>";
          echo "alert('อัพเดทข้อมูลเรียบร้อย !!');";
...
//        echo "</script>";
  ...
  echo "<script>";
   echo "alert('$room_id ตารางห้องไม่ว่าง !!');";
